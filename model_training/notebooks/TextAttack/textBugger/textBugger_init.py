...
def worker(rank: int, world_size: int, all_chunks):
    ...
    attack_args = AttackArgs(
        ...
        log_to_csv=f"textbugger_results_gpu_{rank}.csv",
        disable_stdout=False,
        checkpoint_interval=10,
        checkpoint_dir=f"textbugger_chkpts_gpu_{rank}"
    )
...
if __name__ == "__main__":
    ...
    print("=== TextBugger a rulat pe toate GPU-urile! ===")
