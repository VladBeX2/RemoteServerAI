...
def worker(rank: int, world_size: int, all_chunks):
    ...
    # Importuri după setarea mediului
    import torch
...
if __name__ == "__main__":
    ...
    print("=== PWWS atacuri finalizate pe toate GPU-urile! ===")
