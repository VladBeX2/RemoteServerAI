...
print(f"Eliminate {non_en_count} înregistrări deoarece textul nu e în engleză. Noua dimensiune: {df.shape}")
...
changed_wordopt = (df["text"] != df["text"].apply(wordopt)).sum()
