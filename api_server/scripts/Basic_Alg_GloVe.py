...
### Adaugare date suplimentare
with open("additional_news.json","r", encoding="utf-8") as f:
    additional_data = json.load(f)
additional_df = pd.DataFrame(additional_data)

additional_df.rename(columns={"label": "Label", "text": "Statement"}, inplace=True)

data = pd.concat([data, additional_df], ignore_index=True)
print("Dupa adaugarea datelor suplimentare:", data.shape)
### END Adaugare date suplimentare
